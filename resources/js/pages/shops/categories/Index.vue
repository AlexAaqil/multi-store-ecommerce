...
<template>
    ...
    <div class="app_container">
        <PageHeader 
            ...
            search-placeholder="Search shop categories by name..."
            :show-search-badge="true"
            :create-href="shopCategories.create().url"
        ...
        <div class="shop_categories_table">
                        ...
                        <TableRow v-for="(category, index) in props.categories" 
                            ...
                            <TableCell class="text-center">
                                <div class="flex justify-center space-x-2">
                                    <Link :href="shopCategories.edit(category.id).url" 
                                          class="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 hover:underline">
                                        Edit
                                    </Link>
                                    <span class="text-gray-300 dark:text-gray-600">|</span>
                                    <DeleteConfirmationDialog 
                                        :url="shopCategories.destroy(category.id).url" 
